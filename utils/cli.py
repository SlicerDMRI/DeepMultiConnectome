...
def create_parser():
    ...
    parser.add_argument('--rot_ang_lst', type=str, default="45_10_10", help='"45 15 15" rotate 45 degrees in LR(x) axis, 15 degrees in AP(y) axis, 15 degrees in SI(z) axis')
    parser.add_argument('--scale_ratio_range', type=str, default="0.45_0.05", help='random scale between [1+scale_ratio_range[0], 1+scale_ratio_range[1]]; -0.35 0.05 means scale between 0.65 and 1.05')
    parser.add_argument('--trans_dis', type=float, default=50, help='random translation between [-trans_dis, +trans_dis]')
    parser.add_argument('--aug_times', type=int, default=0, help='How many augmented data we will get for each data.')
    # Local-global representations
    parser.add_argument('--k', type=int, default=0, help='Local streamlines (k_local).the number of neighbor streamlines (in streamline level)')
    ...
    parser.add_argument('--k_global', type=int, default=0, help='Global streamlines (k_global). The number of streamlines (in streamline level) for random sampling')
